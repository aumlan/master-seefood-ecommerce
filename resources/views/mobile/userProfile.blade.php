...
{{--                        <a class="nav-link mb-3 p-3 shadow" id="v-pills-logout-tab" data-toggle="pill" href="#v-pills-logout" role="tab" aria-controls="v-pills-settings" aria-selected="false">--}}
                ...
                <div class="col-md-9">
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade shadow rounded myShadow bg-white show active p-4" id="v-pills-dashboard" role="tabpanel" aria-labelledby="v-pills-dashboard-tab">
                            <h4 class="font-italic mb-4">Hello {{ strtoupper(auth()->user()->name) }}</h4>
                            <img src="site_image/Auto_Insurance.png" alt="user image" width="300px">
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="order-action">
                                                <a href="{{ route('user.order.details', $order->id) }}"
                                                   class=" btn-primary p-2 btn-sm rounded text-white">Details</a>
                                            </td>
