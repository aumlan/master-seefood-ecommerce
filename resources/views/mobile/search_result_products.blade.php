                                    ...
                                    <div class=" d-flex justify-content-between">
                                        <div class="mobileCardDetails w-100">
                                            ...
                                            <p class="template_dark_color font-weight-bold">
                                                {{ Str::limit($product->product_name, 15, '...') }}</p>
                                        </div>

{{--                                        <div class="cart add_to_cart align-items-center" onclick="addToCart({{ $product->product_id }}, 1)">--}}
    ...
    @else
        <div class="container text-center mt-5" >
            ...
            <div style="background-color: #fcfcfc;min-height: 160px;text-align: center;width: 100%;padding-top: 65px">
                <h5>Your search <strong> "{{ $name }}" </strong> didn't match any results. <br/> Look at <a href="/">other items in our store</a> </h5>
            </div>
