                                ...
                                <div class="tab-pane active" id="tabVerticalLeft1" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        <div class="row d-flex">
                                            <div class="col-md-4" ><input class="form-control" type="number" id="sale_price_aed" name="sales_price_aed"
                                                                          placeholder="AED د.إ" value="{{ $product->sales_price_aed }}"></div>
                                            <div class="col-md-4" >
                                                <div class="input-group">
                                                    <span class="input-group-text" id="basic-addon1">$</span>
                                                    <input class="form-control" type="text" name="sales_price" id="sale_price_dollar"
                                                           placeholder="Doller $" readonly value="{{ $product->sales_price }}" >
                                                </div>
                                            </div>
                                            <div class="col-md-4" >
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control" type="text" name="sales_price_euro" id="sale_price_euro"
                                                           placeholder="Euro €" readonly value="{{ $product->sales_price_euro }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="card-body" id="more_box">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <div class="row d-flex">
                                        <div class="col-md-4" ><label for="product_name">FCC ID</label></div>
                                        <div class="col-md-8" ><input type="text" name="fcc_id" id="product_name" placeholder="FCC ID"
                                                                      class="form-control" value="{{ $product->fcc_id }}"></div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row d-flex">
                                        <div class="col-md-4" ><label for="product_name">Model</label></div>
                                        <div class="col-md-8" ><input type="text" name="model" id="product_name" placeholder="Model"
                                                                      class="form-control" value="{{ $product->model }}"></div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row d-flex">
                                        <div class="col-md-4" ><label >IC</label></div>
                                        <div class="col-md-8" ><input type="text" name="ic" id="product_name" placeholder="IC"
                                                                      class="form-control" value="{{ $product->ic }}"></div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row d-flex">
                                        <div class="col-md-4" ><label for="product_name">Transponder Chip</label></div>
                                        <div class="col-md-8" ><input type="text" name="transponder_chip" id="product_name" placeholder="Transponder Chip"
                                                                      class="form-control" value="{{ $product->transponder_chip }}"></div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row d-flex">
                                        <div class="col-md-4" ><label for="product_name">Frequency</label></div>
                                        <div class="col-md-8" ><input type="text" name="frequency" id="product_name" placeholder="Frequency"
                                                                      class="form-control" value="{{ $product->frequency }}"></div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row d-flex">
                                        <div class="col-md-4" ><label for="product_name">Battery</label></div>
                                        <div class="col-md-8" ><input type="text" name="battery" id="product_name" placeholder="Battery"
                                                                      class="form-control" value="{{ $product->battery }}"></div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row d-flex">
                                        <div class="col-md-4" ><label for="product_name">PN</label></div>
                                        <div class="col-md-8" ><input type="text" name="pn" id="product_name" placeholder="PN"
                                                                      class="form-control" value="{{ $product->pn }}"></div>
                                    </div>

                                </div>
                                <div class="form-group">
                                    <div class="row d-flex">
                                        <div class="col-md-4" ><label for="product_name">Keyless Go</label></div>
                                        <div class="col-md-8" ><input type="text" name="keyless_go" id="product_name" placeholder="Keyless Go"
                                                                      class="form-control" value="{{ $product->keyless_go }}"></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row d-flex">
                                        <div class="col-md-4" ><label for="product_name">Weight</label></div>
                                        <div class="col-md-8" ><input type="text" name="weight" id="Kilogram" placeholder="Weight"
                                                                      class="form-control" value="{{ $product->weight }}"></div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row d-flex">
                                        <div class="col-md-4" ><label for="product_name">Length</label></div>
                                        <div class="col-md-8" ><input type="text" name="length" id="Kilogram" placeholder="Length"
                                                                      class="form-control" value="{{ $product->length }}"></div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row d-flex">
                                        <div class="col-md-4" ><label for="product_name">Width</label></div>
                                        <div class="col-md-8" ><input type="text" name="width" id="Kilogram" placeholder="Width"
                                                                      class="form-control" value="{{ $product->width }}"></div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row d-flex">
                                        <div class="col-md-4" ><label for="product_name">Height</label></div>
                                        <div class="col-md-8" ><input type="text" name="height" id="Kilogram" placeholder="Height"
                                                                      class="form-control" value="{{ $product->height }}"></div>
                                    </div>
                            ...
                            <select class="select2 form-control" name="sub_model_id" id="sub_model_id" onchange="setSubModelYear()">
                                @foreach ($brandModels as $brandModel)
                                    <option value="{{ $brandModel->id }}"
                                        @if ($brandModel->id == $product->brand_model_id)
                                            {{'selected="selected"'}}
                                            @endif
                        ...
                        <div class="form-group">
                            ...
                            <select class="select2 form-control" name="sub_model_year_id" id="sub_model_year_id">
                                ...
                                @foreach ($brandModelYears as $brandModelYear)
                                    <option value="{{ $brandModelYear->id }}"
                                    @if ($brandModelYear->id == $product->brand_model_year_id)
                                        {{'selected="selected"'}}
                                        @endif
                                    >{{ $brandModelYear->year }}</option>
                                @endforeach
