...
@section('content')
    <div class="row">
        <div class="col-xl-4 col-lg-4">
            <div class="card">
                <div class="card-body">
                    <form class="form form-vertical" method="POST" action="{{route('admin.product.attribute.store')}}" enctype="multipart/form-data">
                      @csrf
                        @include('Backend.product.attributes.parts.form')
                    </form>
                </div>
            </div>
        </div>
        <div class="col-xl-8 col-lg-8">
            <div class="card">
                <div class="card-body">
                    @include('Backend.product.attributes.parts.attributes_list')
                </div>
            </div>
        </div>
    </div>
