                ...
                <div class="card_content">
                    <div class="row">
                        @foreach ($products as $product)
                            <div class="col-lg-3">
                                <a href="{{ route('product.details', [$product->product_id, $product->slug]) }}">
                                    <div class="card" style="width: 100%;">
                                        @if (count($product->productImage) > 0)
                                            <img class="card-img-top"
                                                 src="{{ mediumImage($product->productImage[0]->image) }}"
                                                 alt="Card image cap">
                                    @endif
                                </a>
                                <div class="card-body">
                                    ...
                                    <div class="recent-listing-header">
                                        <div class="recent-listing-title">{{ $product->product_name }} </div>
                                    </div>
    ...
    @else
        <div class="container text-center" style="min-height: 40vh">
            ...
            <div style="background-color: #fcfcfc;min-height: 160px;text-align: center;width: 100%;padding-top: 65px">
                <h5>Your search <strong> "{{ $name }}" </strong> didn't match any results. Look at <a href="/">other items in our store</a> </h5>
            </div>
