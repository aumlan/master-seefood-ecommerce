...
{{--                    </li>--}}
                    ...
                    <li class="@if(Route::is('admin.shipping')) active @endif"><a href="{{route('admin.shipping')}}"><i class="fa fa-long-arrow-right"></i><span class="menu-item">Shipping Method</span></a>
                    </li>
